...
public class e15 {
    ...
    public static void main(String[] args) {
        String sp = "       ";
        System.out.print("Taxable" + sp + "Single" + sp+ "Married Joint" + sp + "Married" + sp + "Head " +
                "of");
        System.out.print("\nIncome" + sp + "     " + sp + "  Or Qualifying" + sp + "Separate" + "      " + "a " +
                "House");
        System.out.print("\n      " + sp + "       " + sp + "Widow(er)" + sp + "       " + sp + "     ");
        System.out.print(
        ...
        for (int i = 50000; i <= 60000; i += 50) {
            String sp2 = "           ";
            System.out.print("\n" + i);
            System.out.print(sp2 + Math.round(computeTax(0, i)));
            System.out.print(sp2 + Math.round(computeTax(1, i)));
            System.out.print(sp2 + Math.round(computeTax(2, i)));
            System.out.print(sp2 + Math.round(computeTax(3, i)));
        }
    }
